...
- [The Worked Example](./docs/example-curriculum/README.md) — all 96 missions: exactly what the AI is told. Readable on screen ([Design](./docs/example-curriculum/how-to-save-the-world-lessons-design.md) · [Build](./docs/example-curriculum/how-to-save-the-world-lessons-build.md) · [Lead](./docs/example-curriculum/how-to-save-the-world-lessons-lead.md)) or as the source spreadsheet
...
- [Self-Hosting](./docs/SELF_HOSTING.md) — Run a sovereign backend on your own Supabase project
- [Folder Structure](./docs/FOLDER_STRUCTURE.md) — Repository layout
- [Contributing](./CONTRIBUTING.md) — How to contribute to How to Save the World
